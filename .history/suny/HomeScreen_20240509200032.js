...
const HomeScreen = () => {
  ...
  const products = [
    { id: 1, name: 'Produto 1', price: 10, image: require('./path/to/product1.') },
    { id: 2, name: 'Produto 2', price: 20, image: require('./path/to/product2.') },
    { id: 3, name: 'Produto 3', price: 30, image: require('./path/to/product3.') },
    { id: 4, name: 'Produto 4', price: 40, image: require('./path/to/product4.') },
    { id: 5, name: 'Produto 5', price: 50, image: require('./path/to/product5.') },
    { id: 6, name: 'Produto 6', price: 60, image: require('./path/to/product6.') },
  ];
