...
const HomeScreen = () => {
  ...
  const products = [
    { id: 1, name: 'Produto 1', price: 10, image: require('') },
    { id: 2, name: 'Produto 2', price: 20, image: require('') },
    { id: 3, name: 'Produto 3', price: 30, image: require('') },
    { id: 4, name: 'Produto 4', price: 40, image: require('') },
    { id: 5, name: 'Produto 5', price: 50, image: require('') },
    { id: 6, name: 'Produto 6', price: 60, image: require('') },
  ];
